...
sentiment:
- 5
sentiment-hash: e4936c3c
sentiment-label:
- factual
tags:
- technical
---
my [[laptop]] model: rz09-02705w76 

[[graphics processing unit|GPU]]: GTX 1060 Max-Q Design (6 GB GDDR5 VRAM)
RAM 16gb ddr4
...
- The 2018 model doesn't support battery charge control - [source](https://mysupport.razer.com/app/answers/detail/a_id/9681/~/how-to-enable-the-battery-health-optimizer-feature-in-razer-synapse)
### USB ports
- 3x USB 3.0 ports
- There's only 1 [[USB-C|USB C]] port, that's thunderbolt.
...
> [!NOTE]- docking station research
> Third party [[docking station]] (**nvm no [[USB-C Power Delivery|Power Delivery]] support for my blade**)
...
> [!NOTE]- upgraded OS
> upgraded from [[Windows 10]] to [[Windows 11]] Home
> upgraded to [[Windows 11]] Enterprise, see [[change windows version]]

> [!NOTE]- upgraded SSD
> I tried to make space on main drive with: [[change windows 11 default storage]]
> This didn't speed up, or worked well for me
> 
> I [[razor blade 15 - slow write speed|upgraded SSD to fix slow write speed]]
...
- [x] 2025 replaced CMOS battery, see [[razor blade 15 - CMOS battery]]
- [ ] TODO: upgrade ram?

battery
DESIGN CAPACITY	65,003 mWh
FULL CHARGE CAPACITY	57,211 mWh
