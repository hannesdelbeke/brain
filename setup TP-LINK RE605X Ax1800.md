...
Turns out it was because my windows set a [[static IP address|static IP]] for the ethernet, and used a google DNS, changing it back to obtain automatic fixed it. This was a leftover from [[Barrier Ethernet setup]]
### dashboard
