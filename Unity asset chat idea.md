...
- in project is easier, works across branches etc.
- database is more complex, but allows for live conversations and notifications.
### naming
If it's not [[instant messaging]], it's more like [[email]].
asset notes, asset discussions, conversations, asset talk, Asset Ask


> [!idea] AI chat
> Ai chats are becoming popular, perhaps this can tie into this?
