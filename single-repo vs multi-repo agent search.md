...
- *Simple solution:* Open a parent workspace containing active repos as git submodules with a root `AGENTS.md`, or allow the agent to run `gh search code` via GitHub CLI.
