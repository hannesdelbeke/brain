...
* **[[public/2026-08-27 biomimetic AI - stealing from brains, immune systems, and evolution|Voyager (Wang et al., 2023)]]:** Pioneered lifelong learning agents that synthesize executable code into an embedding-indexed skill library. Our design adopts the modular skill library concept but extends it to compile deterministic verification guards (`.githooks`) rather than unconstrained action scripts. (verified 2026-09-01, [arXiv:2305.16291](https://arxiv.org/abs/2305.16291))
* **Reflexion (Shinn et al., 2023):** Introduced verbal reinforcement learning, where agents reflect on failed trajectories and store episodic self-critiques. Our approach replaces LLM self-critique (which suffers from blind spots and hallucinated success) with the **empirical human delta** (Git reversions and steering prompts). (verified 2026-09-01, [arXiv:2303.11366](https://arxiv.org/abs/2303.11366), NeurIPS 2023)
* **ExpeL (Zhao et al., 2023):** Explored extracting cross-task heuristics from experience. We ground these heuristics into structured, testable rules tied to specific line provenance rather than free-form advisory prompts. (verified 2026-09-01, [arXiv:2308.10144](https://arxiv.org/abs/2308.10144), AAAI 2024)
* **AutoSpec & RuleChef (2024–2026):** Counterexample-guided inductive synthesis for extracting symbolic linter rules and safety invariants from execution traces. (verified 2026-09-01: both are real, recent preprints rather than one combined line of work — [AutoSpec, Ma et al.](https://arxiv.org/abs/2606.24245) evolves LLM-agent safety rules via counterexample-guided inductive logic programming, [RuleChef](https://arxiv.org/abs/2607.01293) learns human-editable rules from examples via LLM synthesis; the "linter rules... from execution traces" phrasing is this note's own paraphrase across the two, not a quote from either)
