...
1. if you type a word, and [[large language model|LLM]] predicts the rest of the word or sentence.
   Inline suggestions, Text prediction
2. if you type `[[` and a dropdown shows notes that start with the letters I type.
	   Similar to the code completion in an IDE, when it shows a list of methods that are exposed on a var when you type `my_var.`
