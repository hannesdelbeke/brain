...
[[Game dev flow]]
[[2026-02-16 Game dev flow typed link contract v1]]


[[DevTasks]]
it moves info into the unity project, completely integrating it with the editor.
Instead of my solution, where it links to an external Obsidian vault.

I like that they visualize sticky notes in [[Task Atlas]] in editor in the 3d game world
- [[Editor sticky notes in Unreal]]