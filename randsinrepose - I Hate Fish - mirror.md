...
Let’s start with Rule #1 regarding these tools: if the work to maintain the given tool is greater than the perceived value it creates, I will ignore or stop using it.[1](https://randsinrepose.com/archives/i-hate-fish/?utm_source=tldrproduct#fn-5452-1 "Read footnote.") This is the failure state for most productivity systems. I become frustrated because the work does not justify the value. The details here are important.
...
**LATER:** Slippery. If I’ve done an honest mental assessment of Respond, Later is a valid choice. There are very good reasons to schedule a response for Later, such as the complexity of the topics or the need to consider a response deeply, but Later compounds. One Later — not a big deal. One hundred Laters is an immense pile of work, a compounding management task that will eventually prevent you from doing actual work.[2](https://randsinrepose.com/archives/i-hate-fish/?utm_source=tldrproduct#fn-5452-2 "Read footnote.")
...
**LATER:** Ok, not today, but when. Same buckets as above: tonight, near future, or distant future. _Wait_, I’m still trying to figure it out. I can’t commit nor schedule, so let’s move it to the Someday bucket[4](https://randsinrepose.com/archives/i-hate-fish/?utm_source=tldrproduct#fn-5452-4 "Read footnote.").
...
The scheduling bit is 100% the same as mail: today, a date in the near future, a date in the distant future, and, if I’m brave, never. You should probably read this footnote[5](https://randsinrepose.com/archives/i-hate-fish/?utm_source=tldrproduct#fn-5452-5 "Read footnote.").
...
2. [Superhuman rules](https://superhuman.com/). Mails scheduled for later are removed from the inbox. The tool matters a lot to support the habits. See the last footnote. 
