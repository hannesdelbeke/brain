...
- [ ] **Watch Each Corpus:** A sub-second parse is cheap enough to run on every write, which is what makes the index true rather than as fresh as the last manual reindex.
