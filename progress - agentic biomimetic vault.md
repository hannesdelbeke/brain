...
- [ ] **Evaluate Local Mem0 vs Native SQLite:** Benchmark local open-source `mem0ai` extraction against our native Markdown-append daemon ([[public/2026-08-27 Mem0 memory architecture - cloud pricing, security, and local privacy|Mem0 memory architecture]]).
