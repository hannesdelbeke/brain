...
8. The [[view count]] churn is already gone: the frontmatter field was removed in the 2026-07-22 commit and the tracking moved to a plugin that stores counts outside the notes, see [[2026-07-22 follow up Obsidian viewcount]] and [[obsidian viewcount rnd]]. No action needed there, but it means step 2 is now the only known remaining trigger.
