...
- **Organization size:** 500 employees, 100 software engineers, 200 repositories.
- **Prompt activity:** 15 agent prompts/engineer/day (1,500 total queries/day org-wide).
  - ~15% multi-repo architectural discovery queries (225/day).
  - ~85% single-repo local task queries (1,275/day).
...
- **Naive context dumping / raw grepping:** ~54.4M input tokens/day $\approx$ **$43,000 / year**.
